...
public class AppCustomerTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomercategory.setCustomerCategory("PQTduW1M5LQffoZ9y1GLLK7MBxRRC7Msld1LygbwCpmK7scPf6");
            ...
            appcustomertype.setCustomerType("NHNGURHwiltmmXgDnGvv38tOmtCZuMRCGx5yJgKiybz3SIcCtQ");
            ...
            corecontacts.setEmailId("cOIb0i0Fp1Cp0njj6GyIEclGpwLIXeb3KypIif6zLoC6wyM9CZ");
            corecontacts.setFirstName("GQ60dpharCJuCbmpgcTDWRMP6sa3RJwQO42twG4vuahBUNTSEB");
            Gender gender = new Gender();
            gender.setGender("OFgqGI9kaoTaHtdICyKPR0jqaRaaMZKnmLEsHqNI7O5ssSfwNp");
            Gender GenderTest = genderRepository.save(gender);
            map.put("GenderPrimaryKey", gender._getPrimarykey());
            Language language = new Language();
            language.setAlpha2("Os");
            language.setAlpha3("bYp");
            language.setAlpha4("fFXG");
            language.setAlpha4parentid(6);
            language.setLanguage("LVSfM3f95Akntd2Z3VnPvk4no3N4yifXQlvC9q1R095cA5yzAG");
            language.setLanguageDescription("NRTNXB1N8JLwWd7fCTqkjRkLLpOQSBEDYb1PvVzx15CnKzP64t");
            language.setLanguageIcon("DzdKBN5Bw4Q0URnwkcUJ4kA8AgNfrISXPJnU0MdYMrtOjH8NsA");
            language.setLanguageType("XDX7mBlh3cfkRLAJRA1NHn6xr1Rr9SVs");
            Language LanguageTest = languageRepository.save(language);
            map.put("LanguagePrimaryKey", language._getPrimarykey());
            Timezone timezone = new Timezone();
            timezone.setCities("PWldC34KTLjpeBeOrcXIgeGcHTEEZCKsfVtUUYNhMEVyohGN4d");
            timezone.setCountry("cfcMdaCVaexlw8BF5FfXXt0Cj6kJih2ELQRPJ0SY6IaBwHatlt");
            timezone.setGmtLabel("ZfkpPmoC7PWzlr0dJq2sVMyTAk0iJOF58swDfKu65kc3hL6bKH");
            timezone.setTimeZoneLabel("vfCvijGx4HEuEVBYYP1n8UkQK0Ch3KriIewc9Qfk507opWkVLG");
            timezone.setUtcdifference(0);
            Title title = new Title();
            title.setTitles("EcXSTDrYr0kgnV1zzc7ALZap7vR81RLYrPcUuguhWMj9cvA0ES");
            Title TitleTest = titleRepository.save(title);
            map.put("TitlePrimaryKey", title._getPrimarykey());
            corecontacts.setAge(19);
            corecontacts.setApproximateDOB(new java.sql.Date(123456789));
            corecontacts.setDateofbirth(new java.sql.Date(123456789));
            corecontacts.setEmailId("FC8i9BOQsiXJT5MOQ5FYD851R17y3bSKiqnCEIGZCG5dz3FZK0");
            corecontacts.setFirstName("y3aALvpy5o2hYzAxMa3TmoQepbNK4E5Z4peZtzeJZge1pdgjdG");
            corecontacts.setGenderId((java.lang.String) GenderTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setLastName("YgAXdHM4qr8FDB9kSxXbrWBBTecUS284HGIyY9d6v00DeAzHK4");
            corecontacts.setMiddleName("uCuLzMyIXukkD2epz94dYrKX68OGrTlTqVwZ0FChq845t4b09s");
            corecontacts.setNativeFirstName("jjg0ETWidhmdEa368Ro60cEehAsTyOBLMlcu5TbdJFULxMJo88");
            corecontacts.setNativeLanguageCode((java.lang.String) LanguageTest._getPrimarykey()); /* ******Adding refrenced table data */
            corecontacts.setNativeLastName("3kzd5PZFvvnVluQ3pekcOkhwOO9GB0byCRQBfj98v3wriIqtha");
            corecontacts.setNativeMiddleName("1fj9vRTN9dPhfIbgAFJu6OsBnxNZjMmRclPXQpgiX8s7Qf5fyI");
            corecontacts.setNativeTitle("iwoKrfGOsVV0WqTqy8J4x7KKRd6pywlbTwdCqUVYiZ2j8nbmjn");
            corecontacts.setPhoneNumber("JK0P7QdZrqjRL6fyMcdf");
            ...
            appcustomer.setCustomerName("bhmXVh9u7NqJOBol28b93wMwrF6zJqOkT4vW1ShQj956XmBnrz");
    ...
    public void test2Update() {
        try {
            ...
            appcustomer.setCustomerName("Za3EA5PMOgMvl3vvcYjlGBt3yKzTy1k9Hr3r6ZMTKUuJvO66Ae");
            appcustomer.setCustomerStatus(1);
            appcustomer.setEvalTimePeriod(2147483647);
            appcustomer.setUserRequested(2147483647);
