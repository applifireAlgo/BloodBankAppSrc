...
public class BloodStockTestCase {
    ...
    public void test1Save() {
        try {
            ...
            bloodgroup.setBloodGroup("c8RTVunBjBuZEhCxruKyHJrIEqJNGZKnhf54KWxrdfKxrrVuD0");
            ...
            bloodstock.setBloodGroup((java.lang.String) BloodGroupTest._getPrimarykey());
            bloodstock.setNoOfUnits(8301);
    ...
    public void test3findBybloodGroup() {
        try {
            java.util.List<BloodStock> listofbloodGroup = bloodstockRepository.findByBloodGroup((java.lang.String) map.get("BloodGroupPrimaryKey"));
