...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "2", comments = "Service for DonorVisit Transaction table", complexity = Complexity.MEDIUM)
...
public class DonorVisitServiceImpl extends DonorVisitService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.bloodbank.DonorVisit> lstdonorvisit = donorVisitrepo.findAll();
    ...
    private Map<String, String> getFieldMetaData() {
        ...
        fieldMetaData.put("campId", "String");
        fieldMetaData.put("donor", "String");
    ...
    public HttpEntity<ResponseBean> findByCampId(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.bloodbank.DonorVisit> lstdonorvisit = donorVisitrepo.findByCampId((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdonorvisit);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> findByDonor(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        com.athena.framework.server.bean.ResponseBean responseBean = new ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.bloodbank.DonorVisit> lstdonorvisit = donorVisitrepo.findByDonor((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdonorvisit);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findByDonationType(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.bloodbank.DonorVisit> lstdonorvisit = donorVisitrepo.findByDonationType((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdonorvisit);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.bloodbank.DonorVisit lstdonorvisit = donorVisitrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstdonorvisit);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    @Override
    public HttpEntity<ResponseBean> save(@RequestBody DonorVisit entity) throws Exception, SpartanBusinessValidationFailedException, SpartanDataNotFoundException, SpartanIncorrectDataException, SpartanPersistenceException {
        com.athena.framework.server.bean.ResponseBean responseBean = new com.athena.framework.server.bean.ResponseBean();
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.CREATED;
        stockupdate.proStockUpdate(entity);
        responseBean.add("success", true);
