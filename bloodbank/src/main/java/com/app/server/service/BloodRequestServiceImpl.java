...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "4", comments = "Service for BloodRequest Transaction table", complexity = Complexity.MEDIUM)
...
public class BloodRequestServiceImpl extends BloodRequestService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.bloodbank.BloodRequest> lstbloodrequest = bloodRequestrepo.findAll();
    ...
    public HttpEntity<ResponseBean> findByBloodGroup(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            List<com.app.shared.bloodbank.BloodRequest> lstbloodrequest = bloodRequestrepo.findByBloodGroup((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstbloodrequest);
        } catch (org.springframework.transaction.TransactionException e) {
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.bloodbank.BloodRequest lstbloodrequest = bloodRequestrepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstbloodrequest);
        } catch (org.springframework.transaction.TransactionException e) {
