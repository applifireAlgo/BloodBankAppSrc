...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "5", comments = "Service for BloodGroup Master table Entity", complexity = Complexity.LOW)
...
public class BloodGroupServiceImpl extends BloodGroupService {
    ...
    public HttpEntity<ResponseBean> findAll() throws SpartanPersistenceException, Exception {
        ...
        java.util.List<com.app.shared.bloodbank.BloodGroup> lstbloodgroup = bloodGrouprepo.findAll();
    ...
    public HttpEntity<ResponseBean> findById(@RequestBody FindByBean findByBean) throws SpartanPersistenceException, Exception {
        ...
        org.springframework.http.HttpStatus httpStatus = org.springframework.http.HttpStatus.OK;
        try {
            com.app.shared.bloodbank.BloodGroup lstbloodgroup = bloodGrouprepo.findById((java.lang.String) findByBean.getFindKey());
            responseBean.add("success", true);
            responseBean.add("message", "Successfully retrived ");
            responseBean.add("data", lstbloodgroup);
        } catch (org.springframework.transaction.TransactionException e) {
