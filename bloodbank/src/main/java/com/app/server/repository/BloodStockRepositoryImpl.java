...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "6", comments = "Repository for BloodStock Master table Entity", complexity = Complexity.LOW)
public class BloodStockRepositoryImpl extends SearchInterfaceImpl implements BloodStockRepository<BloodStock> {
    ...
    public List<BloodStock> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.bloodbank.BloodStock> query = emanager.createQuery("select u from BloodStock u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<BloodStock> save(List<BloodStock> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.bloodbank.BloodStock obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.bloodbank.BloodStock s = emanager.find(com.app.shared.bloodbank.BloodStock.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    @Transactional
    public List<BloodStock> findByBloodGroup(String bloodGroup) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("BloodStock.findByBloodGroup");
            query.setParameter("bloodGroup", bloodGroup);
            java.util.List<com.app.shared.bloodbank.BloodStock> listOfBloodStock = query.getResultList();
    ...
    public BloodStock findById(String bloodStockId) throws Exception, SpartanPersistenceException {
        try {
            ...
            com.app.shared.bloodbank.BloodStock listOfBloodStock = (com.app.shared.bloodbank.BloodStock) query.getSingleResult();
            return listOfBloodStock;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
