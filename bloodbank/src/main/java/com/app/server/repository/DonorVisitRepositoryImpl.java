...
public class DonorVisitRepositoryImpl extends SearchInterfaceImpl implements DonorVisitRepository<DonorVisit> {
    ...
    public List<DonorVisit> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.bloodbank.DonorVisit> query = emanager.createQuery("select u from DonorVisit u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<DonorVisit> save(List<DonorVisit> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.bloodbank.DonorVisit obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.bloodbank.DonorVisit s = emanager.find(com.app.shared.bloodbank.DonorVisit.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<DonorVisit> findByCampId(String campId) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.bloodbank.DonorVisit> listOfDonorVisit = query.getResultList();
    ...
    @Transactional
    public List<DonorVisit> findByDonor(String donor) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("DonorVisit.findByDonor");
    ...
    @Transactional
    public DonorVisit findById(String donorVisitId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("DonorVisit.findById");
            query.setParameter("donorVisitId", donorVisitId);
            com.app.shared.bloodbank.DonorVisit listOfDonorVisit = (com.app.shared.bloodbank.DonorVisit) query.getSingleResult();
            return listOfDonorVisit;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
