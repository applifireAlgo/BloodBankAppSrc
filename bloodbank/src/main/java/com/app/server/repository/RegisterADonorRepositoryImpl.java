...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "4", comments = "Repository for RegisterADonor Transaction table", complexity = Complexity.MEDIUM)
public class RegisterADonorRepositoryImpl extends SearchInterfaceImpl implements RegisterADonorRepository<RegisterADonor> {
    ...
    public List<RegisterADonor> findAll() throws SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.bloodbank.RegisterADonor> query = emanager.createQuery("select u from RegisterADonor u where u.systemInfo.activeStatus=1").getResultList();
            return query;
    ...
    public List<RegisterADonor> save(List<RegisterADonor> entity) throws SpartanPersistenceException {
        try {
            ...
            for (int i = 0; i < entity.size(); i++) {
                com.app.shared.bloodbank.RegisterADonor obj = entity.get(i);
    ...
    public void delete(String id) throws SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            com.app.shared.bloodbank.RegisterADonor s = emanager.find(com.app.shared.bloodbank.RegisterADonor.class, id);
            emanager.remove(s);
        } catch (javax.persistence.PersistenceException e) {
    ...
    public List<RegisterADonor> findByGender(String gender) throws Exception, SpartanPersistenceException {
        try {
            ...
            java.util.List<com.app.shared.bloodbank.RegisterADonor> listOfRegisterADonor = query.getResultList();
    ...
    @Transactional
    public List<RegisterADonor> findByAddress(String address) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("RegisterADonor.findByAddress");
    ...
    @Transactional
    public RegisterADonor findById(String registerADonorId) throws Exception, SpartanPersistenceException {
        try {
            javax.persistence.EntityManager emanager = emfResource.getResource();
            javax.persistence.Query query = emanager.createNamedQuery("RegisterADonor.findById");
            query.setParameter("registerADonorId", registerADonorId);
            com.app.shared.bloodbank.RegisterADonor listOfRegisterADonor = (com.app.shared.bloodbank.RegisterADonor) query.getSingleResult();
            return listOfRegisterADonor;
        } catch (javax.persistence.PersistenceException e) {
            throw new com.athena.framework.server.exception.repository.SpartanPersistenceException("Error in executing query", e);
        }
