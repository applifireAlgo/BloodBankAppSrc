...
public class RepositoryAspect {
    ...
    @Pointcut("execution(* com.app.server.repository..save*(..))")
    protected void saveOperation() {
    }

    @Pointcut("execution(* com.app.server.repository..update*(..))")
    protected void updateOperation() {
    }

    @Pointcut("execution(* com.app.server.repository..delete*(..))")
    protected void deleteOperation() {
    }

    @Pointcut("execution(* com.app.server.repository..find*(..))")
    protected void findOperation() {
    }

    @Pointcut("execution(* com.app.server.repository..get*(..))")
    protected void getOperation() {
    }

    @Pointcut("execution(* com.app.server.repository..*(..))")
