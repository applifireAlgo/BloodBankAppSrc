...
public interface RegisterADonorRepository<T> extends SearchInterface {
    ...
    public List<T> findByAddress(String address) throws Exception, SpartanPersistenceException;

    public T findById(String registerADonorId) throws Exception, SpartanPersistenceException;
}
