...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "4", comments = "BloodRequest", complexity = Complexity.LOW)
...
public class BloodRequest implements Serializable, CommonEntityInterface, Comparator<BloodRequest> {
    ...
    @JsonSerialize(using = CustomJsonTimestampSerializer.class)
    @JsonDeserialize(using = CustomJsonTimestampDeserializer.class)
    private Timestamp dispatchedToPatientOnDT;
    ...
    public Timestamp getDispatchedToPatientOnDT() {
        return dispatchedToPatientOnDT;
    }

    public void setDispatchedToPatientOnDT(Timestamp _dispatchedToPatientOnDT) {
    ...
    public String getPrimaryDisplay() {
        ...
        sb.append((requestedByDoctor == null ? " " : requestedByDoctor) + ",");
    ...
    public boolean equals(Object obj) {
        try {
            com.app.shared.bloodbank.BloodRequest other = (com.app.shared.bloodbank.BloodRequest) obj;
            if (bloodRequestId == null) {
                return false;
