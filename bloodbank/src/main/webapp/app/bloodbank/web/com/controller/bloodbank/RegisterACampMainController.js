Ext.define('Bloodbank.bloodbank.web.com.controller.bloodbank.RegisterACampMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.registerACampId;
          me = this;
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.registerACampId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
