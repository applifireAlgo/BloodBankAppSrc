Ext.define('Bloodbank.bloodbank.web.com.controller.bloodbank.RegisterADonorMainController', {
     ...
     onDeleteActionColumnClickMainGrid: function(grid, rowIndex) {
          var recordId = grid.store.data.items[rowIndex].data.registerADonorId;
          me = this;
     ...
     saveForm: function(but, evt) {
          ...
          var method;
          if (jsonData.registerADonorId == null) {
               method = 'POST'
          } else {
               method = 'PUT';
               jsonData.systemInfo = {
