Ext.define('Bloodbank.bloodbank.web.com.controller.bloodbank.BloodStockMainController', {
     ...
     treeClick: function(me, record, item, index, e, eOpts) {
          if (record.data.leaf) {
               var gridPanel = this.view.up().down('#BloodStockGrid');
               ...
               var formPanel = this.getView().up().down("#BloodStock");
     ...
     loadData: function(responseData) {
          this.view.down('#BloodStock').getViewModel().setData(responseData.response.data);
     },
