 ...
 */
Ext.define('Bloodbank.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Bloodbank.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Bloodbank.view.fw.component.DateTimePicker(o);
    },
    ...
    getValues : function(){
    	...
    	return this.getSubmitValue()+" "+timezone;
    }
