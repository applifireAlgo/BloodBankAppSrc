...
ART_CREATE_PATH=/tmp/applifire/db/ATFYFQO0G7U2897NZHRUCQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/create
AST_CREATE_PATH=/tmp/applifire/db/ATFYFQO0G7U2897NZHRUCQ/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/create
MYSQL=/usr/bin
APPLFIREUSER=root
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_BloodStock_M.sql"; 
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_RegisterDonorToCamp_M.sql"; 

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "SOURCE $AST_CREATE_PATH/alter_ast_BloodResult_T.sql"; 
